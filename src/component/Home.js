...
const Home = () => {
  ...
  const link = [
    { href: "https://www.instagram.com/aryansingh070503/?hl=en", icon: <FaInstagram />, color: "#c32aa3", id: 1 },
    { href: "https://x.com/karansnh007", icon: <FaSquareXTwitter />, color: "#000000", id: 2 },
    { href: "mailto:karansnh007@gmail.com", icon: <SiGmail />, color: "#BB001B", id: 3 },
    { href: "https://github.com/rimuru2003", icon: <FaGithub />, color: "#000000", id: 4 },
    { href: "https://www.linkedin.com/in/aryan-singh-a57715224/", icon: <FaLinkedin />, color: "#0a66c2", id: 5 }
  ];
  useEffect(() => {
    if (w < name.length) {
      const textapp = () => {
      ...
      <div className="ho2">
        ...
        <div className={`menu ${isActive ? "active" : ""}`}>
          ...
          >
            ...
            <ul>
            {link?.map(({ href, icon, color, id }) => (
                <li key={id} style={{ "--i": id, "--clo": color }}>
